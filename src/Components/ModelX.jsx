...
export default function ModelX() {
  ...
  return (
    <section
      className="p-2 md:bg-model-x-desktop bg-model-x-mobile bg-no-repeat  md:bg-center h-screen bg-cover overflow-hidden"
      data-aos="fade-in"
    >
      <div className="flex flex-col h-3/4 items-center mt-20 py-20 md:py-0">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4 items-center md:p-11 p-4 mt-56 md:mdt-72   ">
          <a href="#">
